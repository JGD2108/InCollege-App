      ...
      *> WS-ACCOUNTS-EXISTING is an array to hold existing usernames and passwords
       ...
       *> Paragraphs
       ...
       LINKAGE SECTION.
         ...
         77 LK-STATUS PIC X(1).
         77 LK-MESSAGE PIC X(100).
         77 LK-TOTAL-JOBS PIC 99.

       PROCEDURE DIVISION USING LK-JOB-DATA LK-USERNAME LK-STATUS LK-MESSAGE LK-TOTAL-JOBS.
         MOVE "N" TO LK-STATUS
      ...
      *> Include SENDREQUEST so building InCollege.cob alone remains runnable.
