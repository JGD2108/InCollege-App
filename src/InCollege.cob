          ...
          ELSE
            PERFORM VARYING WS-VIEW-INDEX FROM 1 BY 1
              ...
              STRING "  " DELIMITED BY SIZE
                     ...
                     ". " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EXP-TITLE(WS-VIEW-INDEX)) DELIMITED BY SIZE
                     " - " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EXP-COMPANY(WS-VIEW-INDEX)) DELIMITED BY SIZE
                INTO OUTPUT-RECORD
              END-STRING
              PERFORM PRINT-LINE
              ...
              STRING "     Dates: " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EXP-START-DATE(WS-VIEW-INDEX)) DELIMITED BY SIZE
                     " - " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EXP-END-DATE(WS-VIEW-INDEX)) DELIMITED BY SIZE
                INTO OUTPUT-RECORD
              END-STRING
              PERFORM PRINT-LINE
          ...
          ELSE
            PERFORM VARYING WS-VIEW-INDEX FROM 1 BY 1
              ...
              STRING "  " DELIMITED BY SIZE
                     WS-VIEW-INDEX DELIMITED BY SIZE
                     ". " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EDU-DEGREE(WS-VIEW-INDEX)) DELIMITED BY SIZE
                     " - " DELIMITED BY SIZE
                     FUNCTION TRIM(WS-VIEW-EDU-UNI(WS-VIEW-INDEX)) DELIMITED BY SIZE
                INTO OUTPUT-RECORD
              END-STRING
              PERFORM PRINT-LINE
